...
{
    /// <summary>
    /// AssetComponent 的 Texture3D 资源加载扩展。
    /// </summary>
    /// <remarks>
    /// Texture3D asset loading extensions for AssetComponent.
    /// </remarks>
    ...
    public static class AssetComponentTexture3DExtensions
    {
        ...
        /// </summary>
        /// <remarks>
        /// Asynchronously loads a Texture3D asset.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Synchronously loads a Texture3D asset.
        /// </remarks>
        /// <param name="assetComponent">资源组件实例 / AssetComponent instance</param>
        /// <param name="path">资源路径 / Asset path</param>
